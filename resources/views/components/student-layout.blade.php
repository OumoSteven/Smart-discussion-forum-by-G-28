                ...
                <main class="px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-[1.6fr,0.9fr] gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Logout Card -->
                            <section class="rounded-2xl bg-gradient-to-br from-rose-500 via-rose-600 to-pink-600 text-white p-5 shadow-sm card-hover relative overflow-hidden">
                                ...
                                <div class="relative z-10">
                                    <div class="flex items-center justify-between mb-4">
                                        <h2 class="text-lg font-semibold flex items-center gap-2">
                                            <i class="fas fa-door-open"></i> Ready to Leave?
                                        </h2>
                                        <i class="fas fa-wave-hand text-xl"></i>
                                    </div>
                                    <p class="text-sm text-white/90 mb-4">End your session securely. You can log back in anytime.</p>
                                    
                                    <form method="POST" action="{{ route('logout') }}" class="mt-4">
                                        @csrf
                                        <button type="submit" class="w-full px-4 py-2.5 rounded-xl bg-white text-rose-600 font-semibold shadow-sm hover:bg-slate-50 transition transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
                                            <i class="fas fa-sign-out-alt"></i> Logout Now
                                        </button>
                                    </form>
                                    
                                    <!-- Additional info -->
                                    <div class="mt-4 pt-4 border-t border-white/20 text-xs text-white/70 space-y-1">
                                        <p>✓ Your progress is automatically saved</p>
                                        <p>✓ You'll receive email notifications</p>
                                        <p>✓ Session timeout: 1 hour of inactivity</p>
                                    </div>
                                </div>
                            </section>
                        </div>
